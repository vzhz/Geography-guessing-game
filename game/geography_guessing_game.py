...
if mode == "mix it up!" or mode == "mix it up" or mode == "mix": 
	mode == "placeholder"
	choose_order_in_case_of_placeholder
	...
	while True:
		...
		if user_answer == "quit" or user_answer == "exit":
			...
			if user_wants_to_stay == "N" or user_wants_to_stay == "n":
				...
				fancy_print("Please choose 'Y' to leave or 'N' to stay") #test if this assigns y or n to dont_go
...
if __name__ == '__main__': # do all the stuff that should happen when this runs
	...
	game(q_a_dict, mode, repeat_questions)
